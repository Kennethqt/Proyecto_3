...
class Ventana_inicio(Frame):
    ...
    def __init__(self,master):
        ...
        self.__escuderias = {}
        self.__listaEscuderias = []
        self.inicio()
        return
    #--------------------------------------------------
    #Crea la lista de escuderias
    def CrearLista(self):
        dic=Read()
        lista=[]
        for i in range(len(lista)):
            lista.append(dic[i])
            self.__listaEscuderias = lista
    #--------------------------------------------------
    #Recorrer listo
    def recorrerLista(self):
        lista=[]
        for esc in range(len(self.__listaEscuderias)):
            lista.append(esc["nombre"])
        return lista
    ...
    #--------------------------------------------------
    #Nueva escuderia
    def newEscuderia(self,nombre,ubicacion,patrocinadores,pilotos,automoviles):
        newEscuderia = Escuderia(nombre,ubicacion,patrocinadores,[],[])
        self.__listaEscuderias.append(newEscuderia)
        self.__escuderias[len(self.__escuderias)] = newEscuderia

        dic = {}
        
        for i in range(len(self.__listaEscuderias)):
            dic[i] = self.__listaEscuderias[i].toDiccionario()        
        
        write_inicial(dic)
        
    #--------------------------------------------------
    #Crear el diccionario
    def toDiccioario(self):
        dic = {}
        for i in range(len(self.__escuderias)):
            dic[i] = self.__escuderias[i].toDiccionario()
        return dic
    #---------------------------------------------------
